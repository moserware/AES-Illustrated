...
{
    /// <summary>
    /// Performs Cipher-Feedback (CFB) mode decryption.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal class RijndaelDecryptionCfbTransform : RijndaelDecryptionTransform
    {
        ...
        protected override byte[] InternalTransformBlock(byte[] input)
        {
                 ...
                 ixIteration++)
            {
                ...
                Buffer.BlockCopy(input, currentByteOffset, _LastVector,
